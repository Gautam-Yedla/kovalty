    ...
    <div className="aboutus-root">
      ...
      <section className="aboutus-hero">
        ...
        <div className="aboutus-hero-content">
          <h1 className="aboutus-title">About Kovalty Technologies</h1>
          <p className="aboutus-subtitle">
            Empowering businesses with innovative IT solutions that drive
            efficiency, security, and sustainable growth in the digital age.
          </p>
        </div>
      </section>
          ...
          <div className="aboutus-story-grid">
            <div className="aboutus-story-content">
              ...
              <p className="aboutus-story-text">
                Founded in 2024, Kovalty Technologies emerged from a simple yet
                powerful vision: to make enterprise-grade IT solutions
                accessible to businesses of all sizes. Our founders, having
                witnessed countless organizations struggle with outdated
                technology and complex digital transformations, set out to
                create a different kind of IT partner.
              </p>
              <p className="aboutus-story-text">
                From our humble beginnings as a small consulting firm to
                becoming a trusted technology partner for hundreds of
                organizations worldwide, our journey has been driven by one
                constant: our unwavering commitment to our clients' success.
              </p>

              <div className="aboutus-mission-box">
                <h3>Our Mission</h3>
                <p>
                  To empower businesses with innovative, secure, and scalable IT
                  solutions that transform challenges into opportunities,
                  driving sustainable growth and competitive advantage in an
            ...
            <div className="aboutus-values-grid">
              <div className="aboutus-value-card">
                ...
                <h4>Innovation</h4>
                <p>
                  Pioneering cutting-edge solutions that stay ahead of
              ...
              <div className="aboutus-value-card">
                ...
                <h4>Integrity</h4>
                <p>
                  Building trust through transparency, reliability, and ethical
                  practices
                </p>
              </div>
              <div className="aboutus-value-card">
      ...
      <section className="aboutus-services-section">
        <div className="aboutus-services-container">
          <div className="aboutus-section-header">
            <h2>What We Do</h2>
            <p>
              We provide comprehensive IT services that transform your
              technology challenges into competitive advantages, driving
          ...
          <div className="aboutus-services-grid">
            <div className="aboutus-service-card">
              ...
              <p>
                Custom applications, web platforms, and mobile solutions built
            ...
            <div className="aboutus-service-card">
              ...
              <h3>Cybersecurity</h3>
              <p>
                Comprehensive security audits, implementation, and monitoring to
          ...
          <div className="aboutus-approach-box">
            ...
            <p>
              ...
              Our methodology focuses on understanding your unique business
              challenges first, then crafting tailored solutions that integrate
              seamlessly with your existing operations. Through collaborative
              partnerships, rigorous testing, and continuous optimization, we
              ensure our solutions not only meet your current needs but scale
              with your future growth. Every project is approached with a
              commitment to efficiency, security, and measurable business
              impact.
            </p>
          </div>
        </div>
      ...
      <section className="aboutus-choose-section">
        <div className="aboutus-choose-container">
          <div className="aboutus-section-header">
            ...
            <p>
              Our unique combination of expertise, commitment, and proven
              results sets us apart in the competitive IT services landscape.
            </p>
          </div>
          ...
          <div className="aboutus-benefits-grid">
            <div className="aboutus-benefit-card">
              ...
              <p>
                Deep domain knowledge in fintech, healthcare, and e-commerce
                industries with cutting-edge technology stack mastery.
              </p>
            </div>
            ...
            <div className="aboutus-benefit-card">
              ...
              <p>
                24/7 support with dedicated account managers ensuring your
                systems run smoothly and your goals are met.
              </p>
            </div>
            ...
            <div className="aboutus-benefit-card">
              ...
              <p>
                500+ successful projects with 98% client satisfaction rate and
                average 40% efficiency improvements.
              </p>
            </div>
          </div>
