...
type NavbarProps = {
  ...
  navMenuRef: React.RefObject<HTMLUListElement>;
  mobileToggleRef: React.RefObject<HTMLDivElement>;
  openSidebar: () => void;
};
...
const Navbar: React.FC<NavbarProps> = ({
  ...
  }, [navMenuRef, mobileToggleRef, setIsNavMenuActive]);
      ...
      {/* <div className="sidebar-container">
        ...
        >
          ...
          <div className="social-links">
            ...
            <a
              href="https://www.instagram.com/gautam_yedla/?hl=en"
              className="social-link"
              target="_blank"
              rel="noopener"
            >
